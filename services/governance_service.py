...
# Fallback: real column patterns from known dev.brz tables
# Shown ONLY when live Databricks SDK connection is unavailable.
# When running on Databricks Apps, live data replaces these automatically.
INITIAL_PENDING_REVIEWS = [
    {
        "id": "req-cbp-001",
        "schema_name": "brz",
        "table_name": "claims_billing_phi",
    ...
    },
    {
        ...
        "supervisor_recommendation": "Auto-Approve",
        "ai_explanation": "Dollar-scale decimal pattern and column name match financial billing guidelines.",
        "sample_values": ["***masked***"],
        "status": "PENDING",
        ...
        "category": "Financial",
        "domain": "Brz",
        "concept_match": "Adjudicated Claim Charge",
    ...
    },
    {
        ...
        "native_classification": "PHI - Medical Diagnosis Code",
        "ontology_match": "ICD Medical Coding Taxonomy",
        "similar_columns": [],
        "confidence_score": 0.93,
        "supervisor_recommendation": "Review Recommended",
        "ai_explanation": "Diagnosis code column pattern matches ICD-10 PHI classification.",
        "sample_values": ["***masked***"],
        "status": "PENDING",
    ...
    },
    {
        ...
        "native_classification": "PCI - Financial Account Number",
        "ontology_match": "Patient Billing Account Reference",
        "similar_columns": [],
        "confidence_score": 0.96,
        "supervisor_recommendation": "Auto-Approve",
        "ai_explanation": "Account number pattern matches PCI financial account classification.",
        "sample_values": ["***masked***"],
        "status": "PENDING",
        "submitted_time": datetime.now() - timedelta(hours=8),
        "priority": "High",
        "category": "Financial",
        "domain": "Brz",
        "concept_match": "Patient Billing Account Reference",
        "concept_confidence": 0.96,
        "similar_columns_metrics": [],
        "governance_timeline": [
            {"stage": "Column Discovered in Live Catalog", "timestamp": (datetime.now() - timedelta(days=2)).strftime("%Y-%m-%d %H:%M")},
            {"stage": "AI Classified", "timestamp": (datetime.now() - timedelta(hours=8)).strftime("%Y-%m-%d %H:%M")}
        ]
    },
    {
        "id": "req-hpf-002",
        ...
        "native_classification": "PII - Insurance Identifier",
        "ontology_match": "Health Insurance Plan Identifier",
        "similar_columns": [],
        "confidence_score": 0.86,
        "supervisor_recommendation": "Review Recommended",
        "ai_explanation": "Insurance ID keyword matches PII insurance identifier classification.",
        "sample_values": ["***masked***"],
        "status": "PENDING",
        ...
        "category": "PII",
        "domain": "Brz",
        "concept_match": "Health Insurance Plan Identifier",
    ...
    },
    {
        ...
        "native_classification": "PHI - Patient Identifier",
        "ontology_match": "Patient Master Identifier",
        "similar_columns": ["brz.claims_billing_phi.patient_id (phi:patient_id)"],
        "confidence_score": 0.95,
        "supervisor_recommendation": "Auto-Approve",
        "ai_explanation": "Patient ID column matches PHI patient identifier classification.",
        "sample_values": ["***masked***"],
        "status": "PENDING",
        ...
        "concept_confidence": 0.96,
        "similar_columns_metrics": [
            {"name": "brz.claims_billing_phi.patient_id", "similarity": 97.0}
        ],
        "governance_timeline": [
            {"stage": "Column Discovered in Live Catalog", "timestamp": (datetime.now() - timedelta(days=2)).strftime("%Y-%m-%d %H:%M")},
